...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-ui-editor-detail.ps1

lua tests/test_domain_review.lua

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-ui-editor-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-ui-editor-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion_ui_editor_line-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
